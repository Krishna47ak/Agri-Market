            ...
            <div className="bg-gray-100 w-[30rem] my-10 rounded-2xl">
                <div className="m-5">
                    ...
                    <button className="bg-white flex mx-auto my-7 border border-purple-300 p-3  px-[8.3rem] rounded-xl hover:scale-105 duration-300 text-purple-600 ">
                        ...
                        </svg> <Link to="">Login with Google</Link>
                    </button>
                    ...
                    <div className="mt-3 text-xs flex justify-between items-center text-purple-600">
                        ...
                        <button className="py-2 px-5 bg-white border border-purple-300 rounded-xl hover:scale-110 duration-300"><Link to="/signup">Signup</Link></button>
                    </div>
                </div>
            </div>
        </div>
