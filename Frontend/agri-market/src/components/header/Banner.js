        ...
        <Fragment>
            <div className='flex justify-center relative my-2'>
                ...
                <div className='absolute text-white font-Poppins top-1/4 bg-[#9ca3af99] p-5 rounded-2xl bg-opacity-100' >
                    ...
                    <p className='hidden md:block text-center w-96 mx-auto text-slate-900' >Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Aliquam Libero Nostrum Veniam Facere Tempore Nisi.</p>
